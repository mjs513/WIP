...
#include "ILI9488.h"
#if defined(__AVR__) || defined(__IMXRT1052__)
...
#if defined(ESP8266) || defined (ARDUINO_ARCH_ARC32) || defined(__IMXRT1052__)
...
#if defined(USE_FAST_PINIO) && (!defined (_VARIANT_ARDUINO_STM32_) && !defined(__IMXRT1052__))
  *dcport &= ~dcpinmask;
  *csport &= ~cspinmask;
#else
